...
<header class="sticky top-0 z-50 bg-[#2D2D2D] border-b border-[#3A3A3A]">
    <div class="max-w-lg mx-auto px-4 py-3 flex items-center gap-4">
        <a href="/clients" class="flex items-center text-white hover:text-[#FDFBD8] transition-colors">
...
<div class="max-w-lg mx-auto px-4 py-6">
    ...
    <div class="flex gap-3">
        ...
        <button onclick="shareClientProject()" class="py-3 px-4 border border-[#3A3A3A] text-white text-sm font-semibold font-['Bricolage_Grotesque',sans-serif] rounded-lg hover:border-[#FDFBD8] transition-colors">
