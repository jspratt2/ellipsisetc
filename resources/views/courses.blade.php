...
<body class="bg-[#2D2D2D] min-h-screen">
    ...
    <div class="min-h-screen w-full bg-[#2D2D2D]">
        ...
        <div class="max-w-lg mx-auto no-scrollbar" style="overflow-y: auto;">
            ...
            $courseItems = [
                [
                    'title' => 'AI Visual Production System',
                    ...
                    'link' => 'https://stan.store/ohneis',
                ],
                [
                    'title' => 'Prompt System for On-Brand AI Visuals',
                    'category' => 'System',
                    'price' => '$149',
                    'images' => [
                        'https://images.unsplash.com/photo-1676299081847-824916de030a?w=800&h=800&fit=crop',
                        'https://images.unsplash.com/photo-1675557009875-436f7a5e6d2e?w=800&h=800&fit=crop',
                    ],
                    'link' => 'https://stan.store/ohneis',
                ],
                [
                    'title' => 'Ultimate Prompt Collection',
                    'category' => 'Prompt Library',
                    'price' => '$29',
                    'images' => [
                        'https://images.unsplash.com/photo-1655720828018-edd2daec9349?w=800&h=800&fit=crop',
                    ],
                    'link' => 'https://stan.store/ohneis',
                ],
                [
                ...
                [
                    ...
                    'price' => '$199',
                    'images' => [
                        'https://images.unsplash.com/photo-1536240478700-b869070f9279?w=800&h=800&fit=crop',
                        'https://images.unsplash.com/photo-1574717024653-61fd2cf4d44d?w=800&h=800&fit=crop',
                        'https://images.unsplash.com/photo-1492724441997-5dc865305da7?w=800&h=800&fit=crop',
                    ],
                    'link' => 'https://stan.store/ohneis',
                ],
                [
                    'title' => 'Character Design with AI',
                    'category' => 'Design',
                    'price' => '$129',
                    'images' => [
                ...
                <div class="gallery-item group cursor-pointer" onclick="openPostView({{ $index }})">
                    ...
                    <div class="gallery-overlay">
                        <div class="text-center px-2">
                            ...
                            <p class="text-[#FDFBD8] text-xs font-['Bricolage_Grotesque',sans-serif]">{{ $item['price'] }}</p>
                        </div>
                    </div>
                    ...
                    <div style="position: absolute; bottom: 8px; left: 8px;">
                        <span class="bg-[#FDFBD8] text-[#2D2D2D] text-xs font-semibold px-2 py-1 rounded font-['Bricolage_Grotesque',sans-serif]">{{ $item['price'] }}</span>
                    </div>
                </div>
                @endforeach
            </div>
            ...
            <div id="list-view" class="gallery-list" style="display: none;">
                ...
                <div class="list-item" onclick="openPostView({{ $index }})">
                    ...
                    <div class="list-item-info font-['Bricolage_Grotesque',sans-serif]">
                        ...
                        <p class="list-item-price">{{ $item['price'] }}</p>
                    </div>
                </div>
                @endforeach
            </div>
        ...
        <div id="post-scroll-view" class="fixed inset-0 bg-[#2D2D2D] z-50 hidden" style="overflow: hidden;">
            ...
            <div class="absolute top-0 left-0 right-0 bg-gradient-to-b from-black/60 to-transparent z-10 pointer-events-none" style="height: 80px;">
                <div class="px-4 py-3 flex items-center pointer-events-auto">
                    ...
                    <span class="flex-1 text-center text-white font-semibold font-['Bricolage_Grotesque',sans-serif]">Courses</span>
                    <div class="w-6"></div>
                </div>
            </div>
                        ...
                        <a href="{{ $item['link'] }}" target="_blank" class="block cursor-pointer hover:opacity-80 transition-opacity">
                            <div class="flex items-end justify-between">
                                <div>
                                    ...
                                    <p class="text-gray-300 text-sm font-['Bricolage_Grotesque',sans-serif] mt-1">{{ $item['category'] }} · {{ $item['price'] }}</p>
                                </div>
                                <span class="text-[#FDFBD8] text-sm font-['Bricolage_Grotesque',sans-serif]">enroll →</span>
                            </div>
                        </a>
                    </div>
        ...
        <x-reviews-carousel category="courses" />
    </div>
