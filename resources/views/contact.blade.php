                ...
                <div class="w-full max-w-xl z-10 relative pt-8">
                    <div class="w-full max-w-xl mx-auto font-['Bricolage_Grotesque',sans-serif] relative z-10">
                        <div class="relative flex flex-col justify-start items-center min-h-[300px]">
                            <div class="w-full max-w-md sticky top-0 z-10 pt-1w pb-1 rounded-t-lg bg-transparent">
                                <div class="relative">
                            ...
                            <form action="{{ route('contact.send') }}" method="POST">
                                    ...
                                    <div class="w-full rounded-xl shadow-sm overflow-hidden backdrop-blur-md bg-[#252525]/80 border border-[#3A3A3A]" style="opacity: 1; height: auto;">
                                        <ul class="font-['Bricolage_Grotesque',sans-serif]">
                                                    ...
                                                    <div class="flex items-center gap-2 justify-between">
                                                        <div class="flex items-center gap-2">
                                                            <span class="text-gray-300">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="text-[#FDFBD8] h-4 w-4">
                                            ...
                                            <li class="px-3 py-2 font-['Bricolage_Grotesque',sans-serif]" style="opacity: 1; transform: none;">
                                                <input type="text" name="name" placeholder="Name*" required class="mt-1 mb-1 rounded-md bg-transparent border border-white/20 p-3 text-sm font-medium text-white placeholder-white/50 font-['Bricolage_Grotesque',sans-serif] justify-between w-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#069494]"></input>
                                                <span class="text-xs font-medium text-white font-['Bricolage_Grotesque',sans-serif]">First & last name.</span>
                                            </li>
                                            <li class="px-3 py-2 font-['Bricolage_Grotesque',sans-serif]" style="opacity: 1; transform: none;">
                                                <input type="email" name="email" placeholder="Email*" required class="mt-1 mb-1 rounded-md bg-transparent border border-white/20 p-3 text-sm font-medium text-white placeholder-white/50 font-['Bricolage_Grotesque',sans-serif] justify-between w-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#069494]"></input>
                                                <span class="text-xs font-medium text-white font-['Bricolage_Grotesque',sans-serif]">Best reply-to address.</span>
                                            </li>
                                            <li class="px-3 py-2 font-['Bricolage_Grotesque',sans-serif]" style="opacity: 1; transform: none;">
                                                <input type="text" name="company" placeholder="Company*" required class="mt-1 mb-1 rounded-md bg-transparent border border-white/20 p-3 text-sm font-medium text-white placeholder-white/50 font-['Bricolage_Grotesque',sans-serif] justify-between w-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#069494]"></input>
                                                <span class="text-xs font-medium text-white font-['Bricolage_Grotesque',sans-serif]">Company or creator name for invoicing and credits.</span>
                                            </li>
                                            <li class="px-3 py-2 font-['Bricolage_Grotesque',sans-serif]" style="opacity: 1; transform: none;">
                                                <input type="tel" name="phone" placeholder="Phone number (optional)" class="mt-1 mb-1 rounded-md bg-transparent border border-white/20 p-3 text-sm font-medium text-white placeholder-white/50 font-['Bricolage_Grotesque',sans-serif] justify-between w-full cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#069494]"></input>
                                                <span class="text-xs font-medium text-white font-['Bricolage_Grotesque',sans-serif]">Include country code if possible.</span>
                                            </li>
                                            ...
                                            <li class="px-3 py-2 hover:bg-zinc-800/50 rounded-md font-['Bricolage_Grotesque',sans-serif] action-item " style="opacity: 1; transform: none;">
                                                <div class="flex items-center justify-between w-full cursor-pointer">
                                                    <div class="flex items-center gap-2 justify-between">
                                                        <div class="flex items-center gap-2">
                                                            <span class="text-gray-300">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pen-tool h-4 w-4 text-[#FDFBD8]">
                                            ...
                                            <div class="border-t border-[#3A3A3A]"></div>
                                            <li class="px-3 py-2 font-['Bricolage_Grotesque',sans-serif]">
                                                <div class="flex flex-col gap-3">
                                                    ...
                                                    <label class="flex items-center gap-2 text-sm font-medium text-white cursor-pointer">
                                                        <input type="checkbox" name="project_type[]" class="accent-[#069494]" />Landing / product page
                                                    </label>
                                                    <label class="flex items-center gap-2 text-sm font-medium text-white cursor-pointer">
                                                        <input type="checkbox" name="project_type[]" class="accent-[#069494]" />Content system / prompts
                                                    </label>
                                                    <label class="flex items-center gap-2 text-sm font-medium text-white cursor-pointer">
                                                        <input type="checkbox" name="project_type[]" class="accent-[#069494]" />3D / CGI
                                                    </label>
                                                    <label class="flex items-center gap-2 text-sm font-medium text-white cursor-pointer">
                                                        <input type="checkbox" name="project_type[]" class="accent-[#069494]" />Channel analysis & automation
                                                    </label>
                                                </div>
                                                <textarea
                                                    name="message"
                                                    ...
                                                    required
                                                    class="mt-4 w-full rounded-md bg-transparent border border-white/20 p-3 text-sm font-medium text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-[#069494]"
                                                ></textarea>
                                                <span class="mt-1 block text-xs font-medium text-white/70">
                                                    Provide a description of what you need.
                                                </span>
                                            </li>
                                            <div class="border-t border-[#3A3A3A]"></div>
                                            <li class="px-3 py-2 hover:bg-zinc-800/50 rounded-md font-['Bricolage_Grotesque',sans-serif] action-item " style="opacity: 1; transform: none;">
                                            ...
                                            <div class="border-t border-[#3A3A3A]"></div>
                                            <li class="px-3 font-['Bricolage_Grotesque',sans-serif]">
                                                <textarea
                                                    required
                                                ...
                                                ></textarea>
                                                <span class="mt-1 block text-xs font-medium text-white/70">
                                                    Example: “Kickoff when September ends, first assets mid Oct.” <br/> Leave <i>unsure</i> if you don't know yet.
                                                </span>
                                            </li>
                                            ...
                                            <li class="px-3 py-2 font-['Bricolage_Grotesque',sans-serif]">
                                                <div class="flex flex-col gap-3">
                                                    ...
                                                    <label class="flex items-center gap-2 text-sm font-medium text-white cursor-pointer">
                                                        <input type="checkbox" name="assets[]" class="accent-[#069494]" />Brad guidlines / style guide
                                                    </label>
                                                    <label class="flex items-center gap-2 text-sm font-medium text-white cursor-pointer">
                                                        <input type="checkbox" name="assets[]" class="accent-[#069494]" />Product photos / media
                                                    </label>
                                                    <label class="flex items-center gap-2 text-sm font-medium text-white cursor-pointer">
                                                        <input type="checkbox" name="assets[]" class="accent-[#069494]" />None
                                                    </label>
                                                </div>
                                                <span class="mt-2 block text-xs font-medium text-white/70">
                                                ...
                                                <textarea
                                                    placeholder="Links, references, or constraints"
                                                    class="mt-4 w-full rounded-md bg-transparent border border-white/20 p-3 text-sm font-medium text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-[#069494]"
                                                ></textarea>
                                                <span class="mt-1 block text-xs font-medium text-white/70">
                                        ...
                                        <div class="px-3 py-2 border-t border-[#3A3A3A]">
                                            <div class="hover:bg-zinc-800/50 rounded-md font-['Bricolage_Grotesque',sans-serif] action-item " style="opacity: 1; transform: none;">
                                ...
                                <div class="w-full max-w-md px-3 py-3 pb-2 mt-5 hover:bg-white hover:text-black text-gray-400 rounded-lg backdrop-blur-md bg-[#252525]/80 border border-[#3A3A3A]">
                                    <div class="flex flex-col gap-2">
                                        <button type="submit" class="flex items-center gap-2 text-xs font-['Bricolage_Grotesque',sans-serif] hover:text-black hover:bg-white rounded">
