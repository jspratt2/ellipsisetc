    ...
    <div class="min-h-screen w-full bg-[#2D2D2D]">
        ...
        <div class="max-w-lg mx-auto px-4 py-6">
            ...
            <div class="flex gap-3">
                ...
                <button onclick="shareProject()" class="py-3 px-4 border border-[#3A3A3A] text-white text-sm font-semibold font-['Bricolage_Grotesque',sans-serif] rounded-lg hover:border-[#FDFBD8] transition-colors">
